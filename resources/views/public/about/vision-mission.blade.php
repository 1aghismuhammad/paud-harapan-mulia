...
@section('content')
    ...
    <section class="page-section-space">
        <div class="article-container">
            <p class="page-title text-[36px] md:text-[44px] lg:text-[48px]"></p>
            ...
            <div class="mt-10 space-y-10 text-[16px] leading-[1.95] text-site-muted md:mt-12 md:text-[17px] md:leading-[2] lg:text-[18px] lg:leading-[2]">
                ...
                <section>
                    <h3 class="mb-5 text-[20px] font-semibold tracking-[0.02em] text-site-text uppercase md:text-[21px] lg:text-[22px]">Visi</h3>
                    <p class="text-[18px] font-medium leading-[1.85] text-site-text md:text-[20px] lg:text-[22px] lg:leading-[1.85]">
                        “Mewujudkan Generasi Islam yang Sehat, Mandiri, Kreatif, Berakhlak Mulia dan Berjiwa Pancasila.”
                    </p>
                </section>

                <section>
                    <h3 class="mb-5 text-[20px] font-semibold tracking-[0.02em] text-site-text uppercase md:text-[21px] lg:text-[22px]">Misi</h3>
                    <ul class="space-y-5">
                ...
                <section>
                    <h3 class="mb-5 text-[20px] font-semibold tracking-[0.02em] text-site-text uppercase md:text-[21px] lg:text-[22px]">Tujuan</h3>
                    <ul class="space-y-5">
