    ...
    <section class="page-section-space">
        <div class="article-container">
            <div class="mt-10 space-y-10 text-[16px] leading-[1.95] text-site-muted md:mt-12 md:text-[17px] md:leading-[2] lg:text-[18px] lg:leading-[2]">
                ...
                <section>
                    <h2 class="mb-5 text-[20px] font-semibold tracking-[0.02em] text-site-text uppercase md:text-[21px] lg:text-[22px]">Visi</h2>
                ...
                <section>
                    <h2 class="mb-5 text-[20px] font-semibold tracking-[0.02em] text-site-text uppercase md:text-[21px] lg:text-[22px]">Misi</h2>
                    <ul class="space-y-5">
                ...
                <section>
                    <h2 class="mb-5 text-[20px] font-semibold tracking-[0.02em] text-site-text uppercase md:text-[21px] lg:text-[22px]">Tujuan</h2>
                    <ul class="space-y-5">
