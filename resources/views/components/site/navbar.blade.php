    ...
    <div class="site-container flex min-h-16 items-center justify-between lg:min-h-14">
        ...
        >
            <img
                ...
                class="h-12 w-12 shrink-0 object-contain object-left"
            >
        ...
        <nav class="hidden items-center lg:flex" aria-label="Navigasi utama">
            ...
            <div class="group relative">
                ...
                {{-- Invisible hover bridge: keeps the dropdown open while the cursor moves downward. --}}
                <span
                ...
                <div class="dropdown-panel !top-[calc(100%+3px)] !w-[300px] !px-6 !py-4">
                    <a href="{{ route('about.history') }}" class="dropdown-item !py-[17px]">Sejarah</a>
                    <a href="{{ route('about.vision-mission') }}" class="dropdown-item !py-[17px]">Visi & Misi</a>
                    <a href="{{ route('about.facilities') }}" class="dropdown-item !py-[17px]">Fasilitas</a>
                </div>
            </div>
