    ...
    <section class="pt-8 pb-16 md:pt-10 md:pb-20">
        <div class="content-container">
            <div class="text-center">
                ...
                <h1 class="section-title md:text-[42px] lg:text-[46px]">Profil TK</h1>
            </div>
            ...
            <div class="mt-8 grid items-start gap-10 md:mt-10 lg:mt-12 lg:grid-cols-[470px_1fr] lg:gap-[72px]">
                ...
                <div class="max-w-[560px] pt-1 text-[13px] leading-[1.95] text-site-muted md:text-[14px] lg:pt-2 lg:text-[15px] lg:leading-[2]">
                    ...
                    <p class="mt-5">
                        Pembiasaan doa, praktik ibadah, pengenalan Al-Qur’an, pembelajaran kreatif, dan kolaborasi dengan orang tua menjadi arah utama layanan pendidikan TK Harapan Mulia.
                    </p>
                </div>
            </div>
            ...
            @php
                $showcases = [
                    [
                        ...
                        'panel' => '#EAD9EF',
                        'items' => [
                            ['image' => 'images/paud/fasilitas-aktivitas.jpeg', 'title' => 'Ruang Kelas'],
                            ['image' => 'images/paud/profile-sekolah.jpeg', 'title' => 'Ruang & Lingkungan'],
                            ['image' => 'images/paud/fasilitas-lingkungan.jpeg', 'title' => 'Lingkungan Belajar'],
                            ['image' => 'images/paud/unit-tk.jpeg', 'title' => 'Unit TK'],
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            ['image' => 'images/paud/news-parenting.jpeg', 'title' => 'Kolaborasi Keluarga'],
                        ],
                    ],
                    [
                        'title' => 'Pembiasaan',
                        ...
                        'items' => [
                            ...
                            ['image' => 'images/paud/news-kegiatan.jpeg', 'title' => 'Pembiasaan Islami'],
                            ['image' => 'images/paud/unit-tk.jpeg', 'title' => 'Kegiatan Ibadah'],
                            ['image' => 'images/paud/visi-anak.jpeg', 'title' => 'Kebiasaan Baik'],
                            ['image' => 'images/paud/profile-sekolah.jpeg', 'title' => 'Lingkungan Sekolah'],
                        ],
                    ],
                ];
            @endphp
            ...
            <section class="mt-16 md:mt-20 lg:mt-24">
                ...
                @php
                    $advantages = [
                    [
                        'title' => 'Pembiasaan doa dan praktik ibadah',
                        'content' => 'TK Harapan Mulia membiasakan doa, praktik ibadah, adab, serta rutinitas keagamaan sederhana agar nilai-nilai Islami menjadi bagian dari kegiatan sehari-hari anak.',
                    ],
                    [
                        'title' => 'Pengenalan membaca Al-Qur’an',
                        'content' => 'Anak diperkenalkan pada pembelajaran Al-Qur’an secara bertahap melalui kegiatan yang sesuai dengan usia dan kemampuan, sehingga proses belajar tetap terasa ringan dan menyenangkan.',
                    ],
                    [
                        'title' => 'Pembelajaran kreatif dan menyenangkan',
                        'content' => 'Pembelajaran memadukan aktivitas kreatif, bermain, eksplorasi, dan pengalaman langsung untuk membantu perkembangan kognitif, bahasa, motorik, sosial, dan emosional.',
                    ],
                    [
                        'title' => 'Program parenting',
                        'content' => 'Program parenting menjadi sarana kolaborasi sekolah dan keluarga untuk menyelaraskan pembiasaan, pendampingan, serta perkembangan anak di sekolah dan di rumah.',
                    ],
                    [
                        'title' => 'Pengembangan kemandirian anak',
                        'content' => 'Anak dilatih mengambil peran dalam kegiatan kelas, menyelesaikan tugas sederhana, mengelola kebutuhan pribadi, dan membangun rasa percaya diri melalui pengalaman sehari-hari.',
                    ],
                    ];
                @endphp
                ...
                >
                    ...
                    <div class="hidden md:grid md:grid-cols-[42%_58%]">
                        <div class="border-r border-[#dfe3e6]" role="tablist" aria-label="Keunggulan TK">
