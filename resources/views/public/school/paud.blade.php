    ...
    <section class="pt-8 pb-16 md:pt-10 md:pb-20">
        <div class="content-container">
            <div class="text-center">
                ...
                <h1 class="section-title md:text-[42px] lg:text-[46px]">Profil Sekolah</h1>
            </div>
                ...
                <div class="relative mx-auto w-full max-w-[440px] md:max-w-[470px]">
                    ...
                    <div class="relative z-10 grid grid-cols-2 gap-2.5 md:gap-3 lg:gap-4">
                        ...
                        <div class="overflow-hidden rounded-[8px] bg-white shadow-[0_16px_36px_rgba(17,24,39,0.10)] md:shadow-[0_18px_40px_rgba(17,24,39,0.10)]">
                            <img
                                src="{{ asset('images/paud/unit-paud.jpeg') }}"
                                alt="Aktivitas PAUD Harapan Mulia"
                                class="aspect-[2/3] w-full object-cover transition duration-500 md:aspect-[3/4] hover:scale-[1.035]"
                            >
                        </div>
                    </div>
                ...
                $showcases = [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            ['image' => 'images/paud/unit-paud.jpeg', 'title' => 'Pembiasaan Harian'],
                        ],
                    ],
                ];
            @endphp
                                    ...
                                    @foreach ($showcase['items'] as $index => $item)
                                        ...
                                        >
                                            <img
                                                ...
                                                alt="{{ $item['title'] }} — {{ $showcase['title'] }} PAUD Harapan Mulia"
            ...
            <section class="mt-16 md:mt-20 lg:mt-24">
                ...
                @php
                    ...
                    [
                        ...
                        'content' => 'PAUD Harapan Mulia membangun pembiasaan nilai-nilai Islami melalui doa harian, pengenalan adab, praktik ibadah sederhana, dan aktivitas yang menanamkan kebiasaan baik sejak usia dini.',
                    ],
                    [
